...
# Strip MLP parameters
_C.MODEL.STRIP_MLP = CN()
_C.MODEL.STRIP_MLP.PATCH_SIZE = 4
_C.MODEL.STRIP_MLP.IN_CHANS = 3
_C.MODEL.STRIP_MLP.EMBED_DIM = 80
_C.MODEL.STRIP_MLP.PATCH_NORM = True
_C.MODEL.STRIP_MLP.LAYERS = [2, 8, 14, 2]
